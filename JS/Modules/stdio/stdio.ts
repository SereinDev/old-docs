 ...
 */
export function appendTextToFile(path: string, content: string, encoding: any = Encoding.UTF8) {
 ...
 * @param encoding 要使用的字符编码
 */
export function appendLinesToFile(path: string, content: string[], encoding: any = Encoding.UTF8) {
 ...
 */
export function copyFile(sourceFileName: string, destFileName: string, overwrite: boolean = false) {
 ...
 */
export function getFileCreationTime(path: string): Date {
 ...
 */
export function getFileLastAccessTime(path: string): Date {
 ...
 */
export function getFileLastWriteTime(path: string): Date {
 ...
 */
export function moveFile(sourceFileName: string, destFileName: string, overwrite: boolean = false) {
 ...
 * @param destFileName 文件的新路径和名称
 */
export function renameFile(sourceFileName: string, destFileName: string) {
 ...
 */
export function readAllLinesFromFile(path: string, encoding: any = Encoding.UTF8): string[] {
 ...
 * @param encoding 要使用的字符编码
 */
export function writeLinesToFile(path: string, content: string[], encoding: any = Encoding.UTF8) {
 ...
 * @param encoding 要使用的字符编码
 */
export function writeAllTextToFile(path: string, contents?: string, encoding: any = Encoding.UTF8) {
 ...
 * @returns {boolean}
 */
export function existDirectory(path: string): boolean {
 ...
 */
export function moveDirectory(sourceDirName: string, destDirName: string) {
 ...
 */
export function existFileOrDirectory(path: string): boolean {
 ...
 */
export function getFileNameWithoutExtension(path: string): string | null {
